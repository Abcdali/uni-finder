...
console.log("DATA:", res.data);
 ...
 <ToastContainer position="top-right" autoClose={2000} />
          ...
          <p className="text-center text-[20px] text-[#555] mb-6">
            ...
            <span className="text-[#c88410] font-semibold">Continue</span>
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              <div className={`flex items-center border-2 ${errors.email ? "border-red-500" : "border-black"} rounded-[20px] px-5 py-3`}>
            ...
            <div className="mb-3">
              <div className={`flex items-center border-2 ${errors.password ? "border-red-500" : "border-black"} rounded-[20px] px-5 py-3`}>
            ...
            <a
              href="#"
              className="text-[#c88410] no-underline text-[18px] font-medium text-right block mb-[10px] hover:text-[#a66d0d] hover:underline"
            >
              Forgot Password?
            </a>
            ...
            <button
              type="submit"
              className="w-full py-[15px] border-none rounded-[20px] bg-[#c88410] text-white text-[22px] font-semibold cursor-pointer transition-all duration-300 mb-[15px] hover:bg-[#a66d0d] hover:-translate-y-[2px]"
            >
              Log In
            </button>
          </form>
          ...
          <p className="text-center text-[16px]">
            ...
            <span
              ...
              className="text-[#c88410] font-bold cursor-pointer hover:underline"
            >
              Sign Up
            </span>
          </p>
          ...
          <div className="flex items-center my-5">
            ...
            <p className="mx-[15px] text-[18px] font-medium">
              Or <span className="font-bold text-[#c88410]">log in</span> with
            </p>
          ...
          <div className="flex gap-[15px] justify-center mt-[15px]">
            ...
            <button className="flex items-center justify-center gap-[10px] w-[160px] px-[15px] py-[10px] rounded-[20px] border-2 border-black bg-white text-[16px] font-medium cursor-pointer transition-all duration-300 hover:bg-[#f5f5f5] hover:-translate-y-[2px] hover:border-[#c88410]">
              <img src={facebook} alt="Facebook" className="w-[22px] h-[22px]" />
              Facebook
            </button>
        ...
        <div className="relative w-1/2 flex items-center justify-end bg-white">
          ...
          <img
            ...
            className="absolute right-[-300px] bottom-5 w-[200%] max-w-none h-auto object-contain opacity-90 pointer-events-none top-[60%] -translate-y-1/2"
          />
